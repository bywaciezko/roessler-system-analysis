...
// Funkcja mierząca dolne ograniczenie
    ...
    try {
        ...
        do {
            ...
            case 1: {
                ...
                pw_lower_bound(lower_bound, left, right, p_close_to_6_periodic,
                               N, eps, period);

                // upewnienie się, że dla wyznaczonego dolnego
                // ograniczenia występuje orbita okresowa
            ...
            case 2: {
                ...
                pw_lower_bound(lower_bound, left, right, p_close_to_5_periodic,
                               N, eps, period);
